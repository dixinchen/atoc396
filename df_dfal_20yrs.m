...
% x = squeeze(x(idx_lon_nn, idx_lat_nn, 12*18+month:12:12*37+month));
% 
% 
% % get SSR data
% dr = ncread([gen_path,'data_1_m/GSSR_1_m38.nc'],'ssr');
% ssr = squeeze(dr(idx_lon_nn, idx_lat_nn, 12*18+month:12:12*37+month))./2.628e+6;
% 
% 
% % get TSR data
% dr = ncread([gen_path,'data_1_m/GTSR_1_m38.nc'],'tsr');
% if trend == "deseasonal"
%     tsr = squeeze(dr(idx_lon_nn, idx_lat_nn, 12*28+month:12:12*37+month))./2.628e+6;
...
%     dr = squeeze(dr(idx_lon_nn, idx_lat_nn, 12*28+month:12:12*37+month))./2.628e+6;
