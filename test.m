...
%     data = ncread([gen_path,'dtcwv_1_m10.nc'],'d_tcwv');
...
figure;
hold on
h1 = plot(dfal_sel_m,dR_k_sel_m,'.','MarkerSize',4);%, 'DisplayName','Kernel'
h2 = plot(dfal_sel_m,dR_nn_sel_m,'.','MarkerSize',4);%, 'DisplayName','NN'
h3 = plot(fit_data,fit_dR_k_sel_m,'b--','LineWidth',2);%'LineWidth',8,
h4 = plot(fit_data,fit_dR_nn_sel_m,'r--', 'LineWidth',2);%'LineWidth',8,
ylabel('(SFC, SW) dRw','FontSize',16);xlabel('dcwv','FontSize',16);title('1997-2016, Jan-Dec, (70, 205), interannual','FontSize',16)
